 ...
             transition={{duration:1, ease:"easeOut"}}>
      ...
      <motion.p  initial={{opacity:0, x:100}}
          ...
          transition = {{ duration:2, bounce: 3,stiffness:80,
              ease:"easeInOut"}}>
        I am Olayinka Fagbemi, currently based in Nigeria. I transitioned from growing micro-organisms on a culture plate to writing lines of codes on a web page.   
